...
router.register('submitted-results', views.SubmittedResultViewSet, basename='submitted_result')
...
submitted_result = NestedDefaultRouter(router, 'submitted-results', lookup='submitted_result')
